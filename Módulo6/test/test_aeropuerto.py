...
class TestAeropuerto(TestCase):
    ...
    def test_asigna_slot(self):
        ...
        row = self.aeropuerto.df_vuelos.iloc[0, :]
        self.aeropuerto.slots[1].asigna_vuelo(row['id'], row['fecha_llegada'], pd.to_datetime('2022-08-06 11:50:00'))
        self.aeropuerto.slots[2].asigna_vuelo(row['id'], row['fecha_llegada'], pd.to_datetime('2022-08-06 11:50:00'))

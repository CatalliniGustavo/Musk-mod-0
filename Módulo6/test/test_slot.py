    ...
    def setUp(self):
        self.vuelos = pd.DataFrame.from_dict({'id': {0: 'VY4548', 1: 'VY3887', 2: 'VY1603', 3: 'VY3302', 4: 'VY1121'},
                                              ...
                                              'destino': {0: 'Helsinki', 1: 'Sevilla', 2: 'NuevaYork', 3: 'Bruselas',
                                                          4: 'Paris'}})
        self.vuelos['fecha_llegada'] = pd.to_datetime(
            self.vuelos['fecha_llegada'])
        self.slot = Slot()
        self.slot.asigna_vuelo('VY4548', datetime.datetime(
            2022, 8, 6, 10, 30, 0), datetime.datetime(2022, 8, 6, 11, 40, 0))

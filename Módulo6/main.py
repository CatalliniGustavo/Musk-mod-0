...
def preprocess_data(df_list):
    ...
    df_['fecha_llegada'] = df_['fecha_llegada'].apply(
...
aeropuerto = Aeropuerto(
    vuelos=df, slots=3, t_embarque_nat=60, t_embarque_internat=100)
